  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={title}>
        ...
        <p>
          Diverge Weekly is read by hundreds of designers and foreign policy
